...
namespace CompanyEmployees.Utility
{
    public class EmployeeLinks : IEmployeeLinks
    {
                ...
                string fields, Guid companyId, HttpContext httpContext, List<Entity> shapedEmployees)
        {
            ...
            var employeeCollection = new LinkCollectionWraper<Entity>(shapedEmployees);
        ...
        private LinkCollectionWraper<Entity> CreateLinksForEmployees(HttpContext httpContext,
            LinkCollectionWraper<Entity> employeesWrapper)
        {
